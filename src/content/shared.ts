...
/** Copy shared by every brand. Brand files spread this and override what differs. */
export const SHARED_CONTENT: SharedContent = {
  ...
  infrastructure: {
    ...
    sites: [
      { name: "Denver, CO", status: "LIVE", note: "TODO(demo)" },
      { name: "Abilene, TX", status: "LIVE", note: "TODO(demo)" },
      { name: "Reno, NV", status: "BUILD", note: "TODO(demo)" },
      { name: "Frankfurt, DE", status: "PLANNED", note: "TODO(demo)" },
    ],
  },
